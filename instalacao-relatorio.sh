...
services:
  ...
  java-app:
    ...
    ports:
      - "8080:8080"
    command: java -jar /app-cliente-relatorio-seguro.jar
    network_mode: host
...
then
    ...
    echo "Para inicializar a aplicação use esse comando: docker exec -it java-app java -jar /app-cliente-relatorio-seguro"
fi
