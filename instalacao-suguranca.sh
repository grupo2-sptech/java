...
services:
  ...
  java-app-seguranca:
    ...
    ports:
      - "8080:8080"
    command: java -jar /app-cliente-seguranca.jar
    network_mode: host
...
then
    ...
    echo "Para inicializar a aplicação use esse comando: docker exec -it java-app-seguranca java -jar /app-cliente-seguranca"
fi
